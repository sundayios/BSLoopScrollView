...
/**
 ...
 - BSLoopScrollViewScrollDirectionHorizontal: 水平滚动
 - BSLoopScrollViewScrollDirectionVertical: 垂直滚动
 */
typedef NS_ENUM(NSInteger, BSLoopScrollViewScrollDirection) {
    BSLoopScrollViewScrollDirectionHorizontal = 0,
    BSLoopScrollViewScrollDirectionVertical = 1
};
